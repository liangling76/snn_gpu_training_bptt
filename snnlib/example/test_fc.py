...
if input_type == 'fc':
    sop_obj = sop.Fc(ut.cin, ut.cout).cuda()
    gop_obj = gop.BnFireFc(ut.cin, ut.cout).cuda()
...
ut.check_diff(sop_final, gop_final, 'fc fp')
ut.check_diff(sop_x_grad, gop_x_grad, 'fc bp')
