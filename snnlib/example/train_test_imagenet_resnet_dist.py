'''
training:  python -m torch.distributed.launch --nproc_per_node=4 train_test_imagenet_resnet_dist.py --if_train train
training:  python -m torch.distributed.launch --nproc_per_node=1 train_test_imagenet_resnet_dist.py --if_train test 
'''
...
import time
from models import Resnet_DIST
...
checkpoint = './ckpt/imagenet_resnet_dist.pth.tar'
batch = 32
