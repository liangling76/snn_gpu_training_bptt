...
sop_obj = sop.FireConv(ut.cin, ut.cout).cuda()
gop_obj = gop.BnFireConv(ut.cin, ut.cout, fire=True).cuda()
...
ut.check_diff(sop_final, gop_final, 'fire conv fp')
ut.check_diff(sop_x_grad, gop_x_grad, 'fire conv bp')
